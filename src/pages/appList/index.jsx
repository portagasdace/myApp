...
export default class appList extends Component {
  ...
  render() {
    const { appList, bannerList } = this.state
    return (
        <View className='applist'>
            <View className='applist__header'>
                <Image onClick={this.back_clickHandle.bind(this)} className='applist__header__img' src={back} />
            </View>
                ...
                <View className='applist__section__list'>
                  {
                    appList.map(k=>{
                      return(
                        <View className='applist__section__list__item'>
                            <Image className='item__img' src={k.src} />
                            <Text className='item__name'>
                              {k.name}
                              <AtTag className='item__name__label' size='small' type='primary' circle >标签</AtTag>
                            </Text>
